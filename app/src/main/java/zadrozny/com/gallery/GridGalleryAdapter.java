...
public class GridGalleryAdapter extends RecyclerView.Adapter<GridGalleryAdapter.MyViewHolder> {
    ...
    public GridGalleryAdapter(Context context, List<Uri> images, MainActivity mainActivity) {
        mContext = context;
        this.images = images;
